...
public class MuteManager {
    ...
    private void checkMutes() {
        for (Map.Entry<UUID, MuteInfo> entry : mutedPlayers.entrySet()) {
            ...
            if (muteInfo.expiresAt() == null) continue;
    ...
    public String getDuration(UUID uuid) {
        ...
        return muteInfo.expiresAt() == null ? "<bold><dark_red>PERMANENT</bold>" : TimeUtils.formatDuration(Duration.between(LocalDateTime.now(), muteInfo.expiresAt()));
    }
